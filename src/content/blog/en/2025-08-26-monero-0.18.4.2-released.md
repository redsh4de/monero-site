...
- Wallet: fix privacy leak with malicious remote node (#[10015](https://github.com/monero-project/monero/pull/10015)). For a detailed report, read [Post mortem of `find_and_save_rings()` bug](/blog/2025/08/26/post-mortem-of-find-and-save-rings-bug/)
