...
**BaseReward = 2 _ ((S - A) _ 2<sup>-20</sup> \* 10<sup>-12</sup>)**
...
**Fee per kB = (R/R<sub>0</sub>) _ (M<sub>0</sub>/M) _ F<sub>0</sub> _ (60/300) _ 4**
...
`Fee per kB` = (6.5/10) _ (300/400) _ 0.002 _ (60/300) _ 4 = ~0.0008
...
1. _Median_ fees were taken from [Bitinfocharts](https://bitinfocharts.com/).
