...
import downloadIcon from "@/assets/icons/mask/globe.avif";
---

<MaskIcon src={downloadIcon} size="1.5em" color="#ff6600" />
```
...
import logoIcon from "@/assets/icons/logo.avif";
import logoDarkIcon from "@/assets/icons/logo-dark.avif";
---

<ColorIcon src={logoIcon} darkSrc={logoDarkIcon} size="2em" />
```
...
For examples using `ColorIcon, see `/src/components/layout/header/NavItem.astro`.
